...
class speakingTTS1 extends StatelessWidget {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('안녕하세요.',style: TextStyle(fontSize: MediaQuery.of(context).size.width/8),)
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  SizedBox(width: MediaQuery.of(context).size.width/15,),
                  Text('안녕하세요.',style: TextStyle(fontSize: MediaQuery.of(context).size.width/10),)
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  SizedBox(width: MediaQuery.of(context).size.width/15,),
                  Text('안녕하세요.',style: TextStyle(fontSize: MediaQuery.of(context).size.width/13),)
                ],
              ),
            ],
          ),
