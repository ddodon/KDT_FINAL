...
class speakingTTS3 extends StatelessWidget {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('미안합니다.',style: TextStyle(fontSize: MediaQuery.of(context).size.width/8),)
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  SizedBox(width: MediaQuery.of(context).size.width/15,),
                  Text('미안합니다.',style: TextStyle(fontSize: MediaQuery.of(context).size.width/10),)
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  SizedBox(width: MediaQuery.of(context).size.width/15,),
                  Text('미안합니다.',style: TextStyle(fontSize: MediaQuery.of(context).size.width/13),)
                ],
              ),
            ],
          ),
